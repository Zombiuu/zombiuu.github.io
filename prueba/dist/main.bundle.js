...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__milib_views_cards_card__ = __webpack_require__("../../../../../src/app/milib/views/cards/card.ts");
...
var Actividad1 = (function () {
    ...
    Actividad1.prototype.crearEscenarioMenu = function () {
        ...
        //Boton inicio
        this.btnInicio = new __WEBPACK_IMPORTED_MODULE_3__milib_views_buttons_button__["a" /* Button */](this.motor, this.imgCentral.w / 3, this.imgCentral.h * 0.25, this.imgCentral.w / 3, this.imgCentral.h / 4);
        ...
        //Boton back
        this.btnContinuar = new __WEBPACK_IMPORTED_MODULE_3__milib_views_buttons_button__["a" /* Button */](this.motor, this.imgCentral.w / 3, this.imgCentral.h * 0.5, this.imgCentral.w / 3, this.imgCentral.h / 4);
        ...
        //Boton salir
        this.btnSalir = new __WEBPACK_IMPORTED_MODULE_3__milib_views_buttons_button__["a" /* Button */](this.motor, this.imgCentral.w / 3, this.imgCentral.h * 0.75, this.imgCentral.w / 3, this.imgCentral.h / 4);
    ...
    Actividad1.prototype.crearEscenarioJuego = function () {
        this.dobleClick = [false, false, false, false, false, false];
        this.clicked = false;
        this.ventanaUno = new __WEBPACK_IMPORTED_MODULE_4__milib_views_windows_window__["a" /* Window */](this.motor, 0, 0, __WEBPACK_IMPORTED_MODULE_1__milib_dataholder_dataholder__["a" /* DataHolder */].instance.nScreenWidth, __WEBPACK_IMPORTED_MODULE_1__milib_dataholder_dataholder__["a" /* DataHolder */].instance.nScreenHeight);
        ...
        this.cartaUno = new __WEBPACK_IMPORTED_MODULE_5__milib_views_cards_card__["a" /* Card */](this.motor, this.ventanaUno.w * 0.1, this.ventanaUno.h * 0.1, this.ventanaUno.w / 7, this.ventanaUno.h / 3);
        this.cartaUno.setColor("red");
        //   this.cartaUno.setImagePath("./assets/img/cartasColores/rosa.png");
        this.motor.addViewToParentView(this.ventanaUno, this.cartaUno);
        this.cartaUno.setListener(this);
        this.cartaDos = new __WEBPACK_IMPORTED_MODULE_5__milib_views_cards_card__["a" /* Card */](this.motor, this.ventanaUno.w * 0.3, this.ventanaUno.h * 0.1, this.ventanaUno.w / 7, this.ventanaUno.h / 3);
        this.cartaDos.setColor("black");
        //  this.cartaDos.setImagePath("./assets/img/cartasColores/rojo.png");
        this.motor.addViewToParentView(this.ventanaUno, this.cartaDos);
        this.cartaDos.setListener(this);
        this.cartaTres = new __WEBPACK_IMPORTED_MODULE_5__milib_views_cards_card__["a" /* Card */](this.motor, this.ventanaUno.w * 0.5, this.ventanaUno.h * 0.1, this.ventanaUno.w / 7, this.ventanaUno.h / 3);
        this.cartaTres.setColor("yellow");
        //  this.cartaTres.setImagePath("./assets/img/cartasColores/azul.png");
        this.motor.addViewToParentView(this.ventanaUno, this.cartaTres);
        this.cartaTres.setListener(this);
        this.cartaCuatro = new __WEBPACK_IMPORTED_MODULE_5__milib_views_cards_card__["a" /* Card */](this.motor, this.ventanaUno.w * 0.1, this.ventanaUno.h * 0.5, this.ventanaUno.w / 7, this.ventanaUno.h / 3);
        this.cartaCuatro.setColor("green");
        // this.cartaCuatro.setImagePath("./assets/img/cartasColores/verde.png");
        this.motor.addViewToParentView(this.ventanaUno, this.cartaCuatro);
        this.cartaCuatro.setListener(this);
        this.cartaCinco = new __WEBPACK_IMPORTED_MODULE_5__milib_views_cards_card__["a" /* Card */](this.motor, this.ventanaUno.w * 0.3, this.ventanaUno.h * 0.5, this.ventanaUno.w / 7, this.ventanaUno.h / 3);
        this.cartaCinco.setColor("blue");
        // this.cartaCinco.setImagePath("./assets/img/cartasColores/naranja.png");
        this.motor.addViewToParentView(this.ventanaUno, this.cartaCinco);
        this.cartaCinco.setListener(this);
        this.cartaSeis = new __WEBPACK_IMPORTED_MODULE_5__milib_views_cards_card__["a" /* Card */](this.motor, this.ventanaUno.w * 0.5, this.ventanaUno.h * 0.5, this.ventanaUno.w / 7, this.ventanaUno.h / 3);
        this.cartaSeis.setColor("pink");
        // this.cartaSeis.setImagePath("./assets/img/cartasColores/amarillo.png");
        this.motor.addViewToParentView(this.ventanaUno, this.cartaSeis);
        this.cartaSeis.setListener(this);
        this.arrPreguntas = ["Relaciona las cartas!", "Relaciona las cartas!", "Relaciona las cartas!"];
        this.arrRespuestas = [["./assets/img/cartasColores/blancaRoja.png", "./assets/img/cartasColores/blancaAzul.png", "./assets/img/cartasColores/blancaVerde.png", "./assets/img/cartasColores/blancaRoja2.png", "./assets/img/cartasColores/blancaVerde2.png", "./assets/img/cartasColores/blancaAzul2.png"]];
    ...
    Actividad1.prototype.cardListenerOnClick = function (card) {
        if (this.cartaUno == card) {
            this.cartaUno.setImagePath(this.cartaUno.getImagenFront());
            if (!this.dobleClick[0]) {
                this.dobleClick[0] = true;
                if (!this.clicked) {
                    this.ruta = this.cartaUno.getImagenFront();
                    this.cartaAux = card;
                    this.clicked = true;
                }
                else {
                    var aux = this.cartaUno.getImagenFront();
                    aux = aux.substring(0, aux.length - 4);
                    console.log("AUX:" + aux);
                    this.ruta = this.ruta.substring(0, this.ruta.length - 4);
                    console.log("RUTA:" + this.ruta);
                    var correcto = false;
                    if (aux.includes(this.ruta)) {
                        correcto = true;
                        this.cartaUno.setListener(null);
                        this.quitarListener();
                    }
                    else if (this.ruta.includes(aux)) {
                        correcto = true;
                        this.cartaUno.setListener(null);
                        this.quitarListener();
                    }
                    if (!correcto) {
                        ...
                        setTimeout(function () {
                            ...
                            hola.cartaUno.setImagePath("./assets/img/cartasColores/defecto.png");
                            hola.comprobacionCarta();
                            hola.cartaAux = null;
                        }, 1000);
                    }
                    this.clicked = false;
        ...
        else if (this.cartaDos == card) {
            this.cartaDos.setImagePath(this.cartaDos.getImagenFront());
            if (!this.dobleClick[1]) {
                this.dobleClick[1] = true;
                if (!this.clicked) {
                    this.ruta = this.cartaDos.getImagenFront();
                    this.clicked = true;
                    this.cartaAux = card;
                }
                else {
                    var aux = this.cartaDos.getImagenFront();
                    aux = aux.substring(0, aux.length - 4);
                    this.ruta = this.ruta.substring(0, this.ruta.length - 4);
                    var correcto = false;
                    if (aux.includes(this.ruta)) {
                        correcto = true;
                        this.cartaDos.setListener(null);
                        this.quitarListener();
                    }
                    else if (this.ruta.includes(aux)) {
                        correcto = true;
                    ...
                    if (!correcto) {
                        ...
                        setTimeout(function () {
                            //your code to be executed after 1 second
                            hola.cartaDos.setImagePath("./assets/img/cartasColores/defecto.png");
                            hola.comprobacionCarta();
                            hola.cartaAux = null;
                        }, 1000);
                    }
        ...
        else if (this.cartaTres == card) {
            this.cartaTres.setImagePath(this.cartaTres.getImagenFront());
            if (!this.dobleClick[2]) {
                this.dobleClick[2] = true;
                if (!this.clicked) {
                    this.ruta = this.cartaTres.getImagenFront();
                    this.clicked = true;
                    this.cartaAux = card;
                }
                else {
                    var aux = this.cartaTres.getImagenFront();
                    aux = aux.substring(0, aux.length - 4);
                    this.ruta = this.ruta.substring(0, this.ruta.length - 4);
                    var correcto = false;
                    if (aux.includes(this.ruta)) {
                        correcto = true;
                        this.cartaTres.setListener(null);
                        this.quitarListener();
                    }
                    else if (this.ruta.includes(aux)) {
                        correcto = true;
                    ...
                    if (!correcto) {
                        ...
                        setTimeout(function () {
                            //your code to be executed after 1 second
                            hola.cartaTres.setImagePath("./assets/img/cartasColores/defecto.png");
                            hola.comprobacionCarta();
                            hola.cartaAux = null;
                        }, 1000);
                    }
        ...
        else if (this.cartaCuatro == card) {
            this.cartaCuatro.setImagePath(this.cartaCuatro.getImagenFront());
            if (!this.dobleClick[3]) {
                this.dobleClick[3] = true;
                if (!this.clicked) {
                    this.ruta = this.cartaCuatro.getImagenFront();
                    this.clicked = true;
                    this.cartaAux = card;
                }
                else {
                    var aux = this.cartaCuatro.getImagenFront();
                    aux = aux.substring(0, aux.length - 4);
                    this.ruta = this.ruta.substring(0, this.ruta.length - 4);
                    var correcto = false;
                    if (aux.includes(this.ruta)) {
                        correcto = true;
                        this.cartaCuatro.setListener(null);
                        this.quitarListener();
                    }
                    else if (this.ruta.includes(aux)) {
                        correcto = true;
                    ...
                    if (!correcto) {
                        ...
                        setTimeout(function () {
                            //your code to be executed after 1 second
                            hola.cartaCuatro.setImagePath("./assets/img/cartasColores/defecto.png");
                            hola.comprobacionCarta();
                            hola.cartaAux = null;
                        }, 1000);
                    }
        ...
        else if (this.cartaCinco == card) {
            this.cartaCinco.setImagePath(this.cartaCinco.getImagenFront());
            if (!this.dobleClick[4]) {
                this.dobleClick[4] = true;
                if (!this.clicked) {
                    this.ruta = this.cartaCinco.getImagenFront();
                    this.clicked = true;
                    this.cartaAux = card;
                }
                else {
                    var aux = this.cartaCinco.getImagenFront();
                    aux = aux.substring(0, aux.length - 4);
                    this.ruta = this.ruta.substring(0, this.ruta.length - 4);
                    var correcto = false;
                    if (aux.includes(this.ruta)) {
                        correcto = true;
                        this.cartaCinco.setListener(null);
                        this.quitarListener();
                    }
                    else if (this.ruta.includes(aux)) {
                        correcto = true;
                    ...
                    if (!correcto) {
                        ...
                        setTimeout(function () {
                            //your code to be executed after 1 second
                            hola.cartaCinco.setImagePath("./assets/img/cartasColores/defecto.png");
                            hola.comprobacionCarta();
                            hola.cartaAux = null;
                        }, 1000);
                    }
        ...
        else if (this.cartaSeis == card) {
            this.cartaSeis.setImagePath(this.cartaSeis.getImagenFront());
            if (!this.dobleClick[5]) {
                this.dobleClick[5] = true;
                if (!this.clicked) {
                    this.ruta = this.cartaSeis.getImagenFront();
                    this.clicked = true;
                    this.cartaAux = card;
                }
                else {
                    var aux = this.cartaSeis.getImagenFront();
                    aux = aux.substring(0, aux.length - 4);
                    this.ruta = this.ruta.substring(0, this.ruta.length - 4);
                    var correcto = false;
                    if (aux.includes(this.ruta)) {
                        correcto = true;
                        this.cartaSeis.setListener(null);
                        this.quitarListener();
                    }
                    else if (this.ruta.includes(aux)) {
                        correcto = true;
                    ...
                    if (!correcto) {
                        ...
                        setTimeout(function () {
                            //your code to be executed after 1 second
                            hola.cartaSeis.setImagePath("./assets/img/cartasColores/defecto.png");
                            hola.comprobacionCarta();
                            hola.cartaAux = null;
                        }, 1000);
                    }
    ...
    Actividad1.prototype.pintarPregunta = function () {
        var aux = this;
        aux.arrBoolean = [false, false, false, false, false, false];
        //  aux.lblPregunta.setTexto(this.arrPreguntas[this.indice]);
        aux.cartaUno.setImageFront(this.arrRespuestas[this.indice][this.random()]);
        aux.cartaDos.setImageFront(this.arrRespuestas[this.indice][this.random()]);
        aux.cartaTres.setImageFront(this.arrRespuestas[this.indice][this.random()]);
        aux.cartaCuatro.setImageFront(this.arrRespuestas[this.indice][this.random()]);
        aux.cartaCinco.setImageFront(this.arrRespuestas[this.indice][this.random()]);
        aux.cartaSeis.setImageFront(this.arrRespuestas[this.indice][this.random()]);
    };
    /**
    ...
    Actividad1.prototype.comprobacionCarta = function () {
        if (this.cartaAux == this.cartaUno) {
            this.cartaUno.setImagePath("./assets/img/cartasColores/defecto.png");
        }
        else if (this.cartaAux == this.cartaDos) {
            this.cartaDos.setImagePath("./assets/img/cartasColores/defecto.png");
        }
        else if (this.cartaAux == this.cartaTres) {
            this.cartaTres.setImagePath("./assets/img/cartasColores/defecto.png");
        }
        else if (this.cartaAux == this.cartaCuatro) {
            this.cartaCuatro.setImagePath("./assets/img/cartasColores/defecto.png");
        }
        else if (this.cartaAux == this.cartaCinco) {
            this.cartaCinco.setImagePath("./assets/img/cartasColores/defecto.png");
        }
        else if (this.cartaAux == this.cartaSeis) {
            this.cartaSeis.setImagePath("./assets/img/cartasColores/defecto.png");
        }
    };
    Actividad1.prototype.quitarListener = function () {
        if (this.cartaAux == this.cartaUno) {
            this.cartaUno.setListener(null);
        }
        else if (this.cartaAux == this.cartaDos) {
    ...
    /**
     * random metodo que da un numero aleatorio de 0 a 6.
     */
...
/***/ "../../../../../src/app/milib/views/cards/card.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var Card = (function (_super) {
     ...
     * Metodo de inicializacion de los elementos visuales en el Boton. Se ejecuta ak finalizar el constructor del padre (View)
     */
    function Card(vMotor, vX, vY, vW, vH) {
        var _this = _super.call(this, vMotor, vX, vY, vW, vH) || this;
        _this.sColor = null;
        _this.lblTexto = null;
        _this.imgBack = null;
        ...
        _this.imgBack = new __WEBPACK_IMPORTED_MODULE_3__imgs_imagen__["a" /* Imagen */](_this.motor, 0, 0, _this.w, _this.h);
        _this.motor.addViewToParentView(_this, _this.imgBack);
        _this.imgBack.setImg("../../assets/img/cartasColores/defecto.png");
        _this.imgFront = "";
        _this.lblTexto = new __WEBPACK_IMPORTED_MODULE_1__labels_label__["a" /* Label */](_this.motor, 0, 0, _this.w, _this.h);
        _this.motor.addViewToParentView(_this, _this.lblTexto);
        __WEBPACK_IMPORTED_MODULE_2__events_eventsadmin__["a" /* EventsAdmin */].instance.addMouseClickToView(_this);
     ...
     * Metodo de setter para el listener que escuche los eventos del boton.
     */
    Card.prototype.setListener = function (listener) {
        this.listener = listener;
    };
    /**
     * Metodo que fija la imagen de fondo para el boton, que llama al metodo setImg de la clase Imagen
     * @param vsPath String que contendra la ruta a la imagen en los ASSETS. Ej: './assets/btnsback/back1.png'
     */
    Card.prototype.setImagePath = function (vsPath) {
        this.imgBack.setImg(vsPath);
    };
    Card.prototype.setImageFront = function (vsPath) {
        this.imgFront = vsPath;
    };
    Card.prototype.getImagenFront = function () {
        return this.imgFront;
    };
    /**
     * Metodo que setea el color de fondo del boton.
     */
    Card.prototype.setColor = function (vsColor) {
        this.sColor = vsColor;
    };
    /**
     * Metodo paint del boton (ademas de pintar los hijos, label e imagen, aqui iria el codigo que queramos dar al boton (padre)
     ...
     * @param vctx Contexto donde se va a pintar
     */
    Card.prototype.paint = function (vctx) {
        //console.log(this.xa+"========== "+this.ya);
    };
    /**
     * Metodo para setear el texto del boton.
     * @param vtexto String: Texto del boton.
     */
    Card.prototype.setTexto = function (vtexto) {
        this.lblTexto.setTexto(vtexto);
    };
    /**
     * Metodo heredado del padre View que se ejecutara cuando detecte que en el View se ha pinchado con el raton.
     * @param e Evento de MouseEvent con los detalles del evento.
     */
    Card.prototype.mouseClicked = function (e) {
        if (this.listener != null && this.listener.cardListenerOnClick != undefined)
            this.listener.cardListenerOnClick(this);
    };
    Card.prototype.getLblTexto = function () {
        return this.lblTexto;
    };
    Card.prototype.setSize = function (vWidth, vHeight) {
        _super.prototype.setSize.call(this, vWidth, vHeight);
        this.imgBack.setSize(vWidth, vHeight);
        this.lblTexto.setSize(vWidth, vHeight);
    };
